...
export default function UpdateModal({ ticket, onConfirm, onClose }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="bg-gradient-to-r from-violet-600 to-violet-700 px-6 py-5">
          <div className="flex items-start justify-between">
            <div>
              ...
              <h2 className="text-xl font-bold text-white mt-1.5">Edit Passenger</h2>
              <p className="text-violet-200 text-sm mt-0.5">Update the reservation details below</p>
            </div>
            <button
              onClick={onClose}
        ...
        {/* Seat number locked notice */}
        <div className="mx-6 mt-5 flex items-center gap-2 bg-amber-50 border border-amber-200 rounded-xl px-4 py-2.5 text-xs text-amber-700">
          <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
          </svg>
          <span><strong>Seat number is locked</strong> — cannot be reassigned</span>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-4">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <GenderCard value="male" label="Male" selected={selectedGender === 'male'} register={register} accentClass="violet" />
              <GenderCard value="female" label="Female" selected={selectedGender === 'female'} register={register} accentClass="violet" />
            </div>
          ...
          <div className="flex gap-3 pt-1">
            ...
            <button
              ...
              className="flex-1 py-2.5 rounded-xl bg-violet-600 text-white text-sm font-semibold hover:bg-violet-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-violet-600/25"
            >
...
function fieldClass(error) {
  return `w-full rounded-xl border-2 px-3 py-2.5 text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-offset-0 ${
    error
      ...
      : 'border-gray-200 bg-gray-50 focus:border-violet-400 focus:ring-violet-100 focus:bg-white'
  }`;
}
